<div class="flex items-center justify-center w-9 h-9 font-semibold text-sm text-white rounded-full bg-primary-500 dark:text-primary-500 dark:bg-gray-900 ring-1 ring-inset ring-gray-950/10 dark:ring-white/20" style="background-color: white;">
    <a href="{{ route('filament.admin.pages.appearance') }}">
